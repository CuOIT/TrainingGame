...
void GSLevel::Init()
{
	...
	sprite->Set2DPosition(Globals::screenWidth / 4, Globals::screenHeight / 2.0f);
	...
	sprite->Set2DPosition(Globals::screenWidth / 4,Globals::screenHeight / 2.0f - 220.0f);
	...
	player->Set2DPosition(Globals::screenWidth / 4, 440);
